 ...
 * @author ITSEPT
 */
public final class form_pinjam_kpr extends javax.swing.JInternalFrame {
    ...
    public void dataTable2() {
        Object[] Baris = {"No", "No CIF", "Nama Debitur"};
        tabmode2 = new DefaultTableModel(null, Baris);
        tbl_data_peminjaman.setModel(tabmode2);
        String sql = "select * from tb_jm_kpr where no_cif desc";        
        try {
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()) {
                ...
                String nama_debitur = hasil.getString("nama_debitur");
                String[] data = {"", no_cif, nama_debitur};
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addComponent(F5, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))
    ...
    private void txt_cariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_cariKeyTyped
        // TODO add your handling code here:
        /**  String sqlPencarian = "select * from tb_peminjaman where no_cif like '%" + cari_nasabah.getText() + "%' or "
    ...
    private void btn_cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cariActionPerformed
        // TODO add your handling code here:
        String sqlPencarian = "select * from tb_peminjaman where no_cif like '%" + txt_cari.getText() + "%' or "
   ...
   // txt_no_form.setText(b);
    ...
    private void cari_nasabahKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cari_nasabahKeyTyped
        // TODO add your handling code here:
        String sqlPencarian2 = "select * from tb_jm_kpr where no_cif like '%" + cari_nasabah.getText() + "%' or "
        + "nama_debitur like '%" + cari_nasabah.getText() + "%' or "
        + "keterangan like '%" + cari_nasabah.getText() + "%'";;
