 ...
 * @author ITSEPT
 */
public final class form_pinjam_ukm extends javax.swing.JInternalFrame {
    ...
    public void dataTable2() {
        ...
        String sql = "select * from tb_jm_ukm where no_pinjaman desc";        
        try {
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()) {
    ...
    private void tbl_peminjamanMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_peminjamanMousePressed
        ...
        try {
            ...
            Logger.getLogger(form_pinjam_ukm.class.getName()).log(Level.SEVERE, null, ex);
        }
   ...
   // txt_no_form.setText(b);
    ...
    private void cari_nasabahKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cari_nasabahKeyTyped
        // TODO add your handling code here:
        String sqlPencarian2 = "select * from tb_jm_ukm where no_pinjaman like '%" + cari_nasabah.getText() + "%' or "
