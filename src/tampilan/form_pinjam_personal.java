 ...
 * @author ITSEPT
 */
public final class form_pinjam_personal extends javax.swing.JInternalFrame {
...
//            String sql = "SELECT * FROM tb_jm_personal,tb_jm_ukm WHERE no_pinjaman AND nama_debitur AND tb_jm_personal.no_pinjaman=tb_jm_ukm.no_pinjaman";
            String sql = "select * from tb_jm_personal where no_pinjaman desc";        
        try {
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()) {
                ...
                String nama_debitur = hasil.getString("nama_debitur");
                String[] data = {"", no_pinjaman, nama_debitur};
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cari_nama_debitur, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE)
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel2)
        ...
        F5.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addComponent(F5, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(F5, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ubtn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ubtn_simpanActionPerformed
        // TODO add your handling code here:
        String sql = "update tb_peminjaman set no_form=?,nama_debitur=?,unit_bisnis=?,jumlah_file=?,keperluan=?,tanggal_pinjam=? where no_form='" + utxt_no_form.getText() + "'";
    ...
    private void tbl_peminjamanMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_peminjamanMousePressed
        ...
        try {
            dateValue_kembali = date.parse((String) tbl_peminjaman.getValueAt(bar, 6));
        } catch (ParseException ex) {
            Logger.getLogger(form_pinjam_personal.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void txt_cariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_cariKeyTyped
        // TODO add your handling code here:
        /**  String sqlPencarian = "select * from tb_peminjaman where no_pinjaman like '%" + txt_cari.getText() + "%' or "
   ...
   // txt_no_form.setText(b);
    ...
    private void cari_nasabahKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cari_nasabahKeyTyped
        String sqlPencarian2 = "select * from tb_jm_personal where no_pinjaman like '%" + cari_nasabah.getText() + "%' or "
        + "nama_debitur like '%" + cari_nasabah.getText() + "%' or "
        + "keterangan like '%" + cari_nasabah.getText() + "%'";
