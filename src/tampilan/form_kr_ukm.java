...
//        btn_tanggal.setDate(tgl);
    ...
    public void dataTable() {
        ...
        String sql = "select * from tb_kr_ukm order by no_pinjaman asc";
        try {
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        if (ok == 0) {
            String sql = "delete from tb_kr_ukm where no_pinjaman='" + txt_no_pinjaman.getText() + "'";
            try {
 ...
 //           SimpleDateFormat fm = new SimpleDateFormat(tampilan);
    ...
    private void tbl_kr_ukmMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_kr_ukmMouseClicked
        // TODO add your handling code here:
        
    }//GEN-LAST:event_tbl_kr_ukmMouseClicked
    ...
    private void btn_cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cariActionPerformed
        // TODO add your handling code here:
        String sqlPencarian = "select * from tb_kr_ukm where no_pinjaman like '%" + txt_cari.getText() + "%' or "
    ...
    private void ubtn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ubtn_simpanActionPerformed
        // TODO add your handling code here:
        String sql = "update tb_kr_ukm set no_pinjaman=?,index_=?,nama_debitur=?,kode_marketing=?,nama_marketing=?,jenis_bantex=?,jumlah_bantex=? where no_pinjaman='" + utxt_no_pinjaman.getText() + "'";
//        String tampilan = "dd-MM-yyyy";
//        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
